...
Wrapper Addressables Manager -> Example -> Example Scene Data -> Data Example -> Example Object Addressable (ключ Prefab Example Object Addressable, так же проставить у него Lable "default")
Wrapper Addressables Manager -> Example -> Example Scene Data -> Data Example -> Example Storage Addressables Is Get Obj (ключ SO Example Storage Addressables Is Get Obj)
Wrapper Addressables Manager -> Example -> Example Scene Data -> Data Example -> Example Storage Addressables Update Obj (ключ SO Example Storage Addressables Update Obj)

Wrapper Addressables Manager -> Example -> Example Scene Data -> Data Example -> Example Load Scene -> Example Load Scene Addressable (ключ Scene Example Load Scene Addressable)
