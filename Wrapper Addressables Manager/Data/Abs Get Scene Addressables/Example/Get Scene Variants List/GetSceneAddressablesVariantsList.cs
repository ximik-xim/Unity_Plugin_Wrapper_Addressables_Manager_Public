...
/// <summary>
/// Содержит список вариантов, откудова можно получить(загрузить) сцену.
...
public class GetSceneAddressablesVariantsList : AbsCallbackGetSceneAddressables
{
    ...
    /// </summary>
    [SerializeField]
    private List<AbsCallbackGetSceneAddressables> _variants;
    ...
    /// </summary>
    [SerializeField]
    private List<AbsCallbackGetSceneAddressables> _bufferInit = new List<AbsCallbackGetSceneAddressables>();
                ...
                if (_variants.Count >= lastId + 1)
                {
                    ...
                    void CompletedCallback()
                    {
                        ...
                        if (dataCallback.StatusServer == StatusCallBackServer.Ok)
                        {
                            ...
                            if (_moveNextVariantDataNull == true && dataCallback.GetData.Result.Scene.name == "") 
                            {
